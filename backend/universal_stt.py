    ...
    try:
        ...
        with open(tmp_path, "rb") as audio_file:
            ...
            whisper_lang_map = {
                'en': 'en',   # English
                'ur': 'ur',   # Urdu
                'pnb': 'ur',  # Pakistani Punjabi -> use Urdu for Whisper (better recognition)
                'sd': 'ur',   # Sindhi -> use Urdu for Whisper (similar script)
                'ps': 'ps',   # Pashto
                'bal': 'ur',  # Balochi -> fallback to Urdu for Whisper
            }
